...
Layout, tokens, HUD, interaction.

Read [[canon]], [[stack]], named mechanics. Write `docs/ui/` immediately. No handoff text.

## Writes

`docs/ui/` — tokens, layout, states, interaction. Link from [[ui/_index]].

React + Tailwind sketches only when `src/` exists and the contract is complete.
