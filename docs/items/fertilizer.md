...
Bags are bought at the Additive store and fill its tanks. Not a place ghost. Not on a Build shelf — [[ui/store]] [[ui/build]]. Feed / spike / `bio`: [[mechanics/soil]]. Caps, bags, drink: [[mechanics/inventory]] [[mechanics/_index]].
