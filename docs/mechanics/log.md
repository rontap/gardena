...
Logged: the `Cmd` union. Not logged: sips, rot, weed sprout, ripen, tree drop, grass, stall ticks, research drain, mill / jam / still / barrel ticks, vehicle integrate / burn / follow hitch / boom, sensor eval / hold / pourEligible, walk, panel, camera, camera follow, hover, lens, hangar select. Store is `Act.dock`, not a tick. Boom is not a cmd. `toggle` is actor work. Wire bezier is view.
