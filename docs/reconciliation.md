...
- Diseases, weather, machines, sensors, vehicles, fences, grass seeds, rotary shovel, diamond pickaxe, save/menu/tutorial. Those are not in the game. They will not be written into the working docs.
