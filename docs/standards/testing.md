...
Rewrite the one-sentence invariant on the owning note in the same change as the assertion. Fix the [[mechanics/_index]] id map if the id is new. Do not keep a test that matched the old paragraph.
