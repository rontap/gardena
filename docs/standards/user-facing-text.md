...
| Seed silo pack of grass                    | Grass seeds                                                                                                  | turf seeds                                                |
...
| fertilizer research                        | Synthetic additives                                                                                          | Synthetic fertilizer (that is the bag)                    |
...
| job list at cap                            | I can't remember more errands than that!                                                                     | Queue full, queue                                         |
...
| recap stipend line                         | Support from grandma                                                                                         | Stipend, daily pay                                        |
...
| furnace                                    | Furnace                                                                                                      | kiln, oven                                                |
| infuser                                    | Infuser                                                                                                      | mixer, flavourer, spice machine                           |
| infuse prompt                              | Infuse                                                                                                       | flavour, spice, enchant                                   |
| infused good                               | Infused {name}                                                                                               | spiced, flavoured, enchanted                              |
| flakes                                     | Flakes                                                                                                       | chilli flakes, spice, powder                              |
| vanilla mill item                          | vanilla extract                                                                                              | grass Extract (that is mill grass)                        |
...
| barrel out from an Heirloom Variety        | Premium wine / Premium cider                                                                                 | reserve, vintage, deluxe                                  |
| apple barrel out                           | Cider                                                                                                        |                                                           |
| tomato jam                                 | Ketchup                                                                                                      | tomato jam                                                |
| variety name                               | {Crop} ({Variety})                                                                                           | a bare variety name                                       |
| variety purpose, produce                   | Fresh                                                                                                        | produce, table, eating                                    |
| variety purpose, jam + mill                | Preserving                                                                                                   | processing (the Build shelf), preserve                    |
| variety purpose, still + barrel            | Alcohol                                                                                                      | booze, liquor                                             |
| graft item                                 | {Crop} ({Variety}) graft                                                                                     | cutting, scion, cut grass                                 |
| other jam                                  | {Crop} jam                                                                                                   | preserve                                                  |
| mill outs                                  | Sugar / Olive oil / Flour / Extract / Flakes / vanilla extract                                               | crush, product                                            |
| spirits                                    | Vodka / Beer / Brandy / Mixed spirit                                                                         | liquor, booze, whisky                                     |
| Klosterneuburger apricot spirit            | Barackpálinka                                                                                                | apricot pálinka, apricot brandy                           |
| San Marzano tomato jar                     | Passata                                                                                                      | tomato sauce, tomato jam                                  |
...
| the options page behind the gear           | Settings                                                                                                     | options, preferences, config                              |
| leave a menu page for the buttons          | Back                                                                                                         | return, previous                                          |
| put the options back                       | Revert to default                                                                                            | reset, restore, defaults                                  |
| leave the farm for the startup screen      | Main menu                                                                                                    | quit, exit, title screen                                  |
| motion option                              | Reduced motion                                                                                               | animations off, motion sensitivity                        |
| tab option                                 | Pause when this tab is not in front                                                                          | inactive tab, background pause                            |
| wordmark                                   | Gardena                                                                                                      | the game, this title                                      |
| tree juvenile, not trunk                   | {Name} tree - growing                                                                                        | sapling                                                   |
| tree trunk after chop                      | {Name} tree - trunk                                                                                          | stump, chopped, sapling                                   |
...
| crop names                                 | Carrot / Potato / Wheat / Tomato / Raspberry / Grape / Vanilla / Chilli / Sugar cane                         | berry, shrub, chili                                       |
...
| wood in hand                               | Wood                                                                                                         | log, lumber, timber                                       |
| ash in hand                                | Ash                                                                                                          | cinder, charcoal                                          |
| red spotted mushroom from a burrow          | Fly agaric                                                                                                   | toadstool, death cap, shroom                              |
...
| sprinkler output amount                    | L/day per tile                                                                                               | flow rate, throughput                                     |
...
| gates                                      | Logic gate / NOT gate                                                                                        | OR gate / AND gate as shop titles; or, and, not (bare)    |
| logic mode                                 | OR / AND                                                                                                     | or, and (bare)                                            |
| mill prompts                               | Crush into sugar / Crush into olive oil / Crush into flour / Crush into extract / Crush into vanilla extract / Crush into flakes | mill it                                                   |
| furnace dump                               | Burn                                                                                                         | feed, fire, stoke                                         |
| furnace flour dump                         | Bake                                                                                                         | burn flour, cook                                          |
| chop a mature tree                         | Chop                                                                                                         | fell, cut down                                            |
...
| the buildable book                         | Necronomicon                                                                                                 | tome, grimoire, altar, shrine                             |
| one row of the book                        | page                                                                                                         | task, quest, demand, offering, trial                      |
| giving a thing to the book                 | Sacrifice                                                                                                    | dump, offer, feed, donate, consign, deliver               |
