...
SKU `buy-research-station`. Automation shelf. Unlock and show `unlock-crop-variants`. `need: []`. `haggling`. Guest may buy, place, delete, dump, and open this panel. Not on the shelf until Crop variants is done.
