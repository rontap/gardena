...
export const LEVER_PRICE = 3
export const BUTTON_PRICE = 3
export const LAMP_PRICE = 3
export const OR_PRICE = 8
export const AND_PRICE = 8
export const LOGIC_PRICE = 8
export const NOT_PRICE = 8
export const PULSER_PRICE = 10
export const COUNTER_PRICE = 10
export const SENSOR_WATER_PRICE = 6
export const SENSOR_FERT_PRICE = 6
export const SENSOR_HARVEST_PRICE = 6
export const SENSOR_DAY_PRICE = 12
export const SENSOR_VARIETY_PRICE = 6
export const SENSOR_WEATHER_PRICE = 12
export const WATER_SYSTEM_PRICE = 12
...
export const AUTO_VMAX_MUL = 0.75
export const AUTO_DECEL_MUL = 1.5
