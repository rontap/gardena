...
export const RESEARCH: { readonly [K in ResearchId]: ResearchDef } = {
  ...
  'unlock-can': {
    ...
    cost: 15,
    seconds: 30,
    effect: { kind: 'unlock-sku', sku: 'buy-can' },
  },
  'unlock-large-bucket': {
  ...
  'unlock-large-can': {
    ...
    cost: 30,
    seconds: 50,
    effect: { kind: 'unlock-sku', sku: 'buy-can-large' },
  },
  'unlock-box': {
    id: 'unlock-box',
    tree: 'utilities',
...
export const SKUS: { readonly [K in SkuId]: Sku } = {
  'pack-carrot': { id: 'pack-carrot', price: 10, unlock: 'start' },
  'pack-potato': { id: 'pack-potato', price: 15, unlock: 'start' },
  'pack-wheat': { id: 'pack-wheat', price: 25, unlock: 'start' },
  'pack-tomato': { id: 'pack-tomato', price: 35, unlock: 'unlock-tomato' },
  'pack-raspberry': { id: 'pack-raspberry', price: 50, unlock: 'unlock-raspberry' },
  'buy-shovel': { id: 'buy-shovel', price: 15, unlock: 'start' },
  ...
  'buy-can': { id: 'buy-can', price: 20, unlock: 'unlock-can' },
  'buy-can-large': { id: 'buy-can-large', price: 40, unlock: 'unlock-large-can' },
  'buy-box': { id: 'buy-box', price: 25, unlock: 'unlock-box' },
  'buy-box-large': { id: 'buy-box-large', price: 45, unlock: 'unlock-large-box' },
