...
export const RESEARCH: { readonly [K in ResearchId]: ResearchDef } = {
    ...
    'unlock-sensors': {
        ...
        reveal: 'unlock-auto-irrigation',
        gate: {kind: 'none'},
        blurb: 'Unlocks the Sensors shelf: lever, button, lamp, gates, and field readers.',
        effect: {kind: 'feature'},
    },
...
export const SKUS: { readonly [K in SkuId]: Sku } = {
    ...
    'buy-or': {id: 'buy-or', price: OR_PRICE, tab: 'automation', unlock: 'unlock-sensors', show: 'unlock-sensors', need: 'none'},
    'buy-and': {id: 'buy-and', price: AND_PRICE, tab: 'automation', unlock: 'unlock-sensors', show: 'unlock-sensors', need: 'none'},
    'buy-not': {id: 'buy-not', price: NOT_PRICE, tab: 'automation', unlock: 'unlock-sensors', show: 'unlock-sensors', need: 'none'},
