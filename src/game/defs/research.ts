...
export const RESEARCH: { readonly [K in ResearchId]: ResearchDef } = {
    ...
    'unlock-crop-variants': {
        ...
        requires: [],
        grants: ['Rarity rolls on ripen', 'Uncommon and Rare rows in the seed silo'],
        blurb: 'Happy plants can ripen as a better grade. Shop packs stay Common until you learn Trusted seed bank.',
        effect: {kind: 'feature'},
    },
    'unlock-heirloom': {
        id: 'unlock-heirloom',
