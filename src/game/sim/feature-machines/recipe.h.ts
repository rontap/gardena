...
export type MachineId = 'mill' | 'jam' | 'still' | 'barrel' | 'grinder' | 'compost-box' | 'furnace' | 'infuser'
...
export type CraftCell = Mill | JamMachine | PotStill | Barrel | Grinder | CompostBox | Furnace | Infuser
