import type { AppleTree, Chest, CompostBox, Grinder, House, Pump, Rock, Shrub, Truck } from './building.ts'
...
export type Cell = Plot | House | Pump | Rock | Shrub | AppleTree | Chest | Grinder | CompostBox | Truck
