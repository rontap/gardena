...
import itemHangar from '../../assets/items/item-hangar.svg?raw'
import itemTractor from '../../assets/items/item-tractor.svg?raw'
import itemTrailerSeed from '../../assets/items/item-trailer-seed.svg?raw'
import itemTrailerSpray from '../../assets/items/item-trailer-spray.svg?raw'
import itemTrailerHarvest from '../../assets/items/item-trailer-harvest.svg?raw'
import itemSiloSeed from '../../assets/items/item-silo-seed.svg?raw'
import itemSiloSpray from '../../assets/items/item-silo-spray.svg?raw'
import itemSiloProduce from '../../assets/items/item-silo-produce.svg?raw'
...
import itemFence from '../../assets/items/item-fence.svg?raw'
...
import itemWell from '../../assets/items/item-well.svg?raw'
import itemPipe from '../../assets/items/item-pipe.svg?raw'
import itemSprinkler from '../../assets/items/item-sprinkler.svg?raw'
...
import uiBtnRotate from '../../assets/ui/ui-btn-rotate.svg?raw'
import uiBtnCancel from '../../assets/ui/ui-btn-cancel.svg?raw'
import uiBtnFamily from '../../assets/skills/ui-btn-family.svg?raw'
import uiBtnGear from '../../assets/ui/ui-btn-gear.svg?raw'
import uiBtnPause from '../../assets/ui/ui-btn-pause.svg?raw'
import uiBtnPlay from '../../assets/ui/ui-btn-play.svg?raw'
...
export function pulserArt(on: boolean): string {
  return stageOnly(propPulser, on ? 'on' : 'off')
}
export function counterArt(group: 's0' | 's1' | 's2' | 's3' | 's4'): string {
  return stageOnly(propCounter, group)
}
...
export function daySensorArt(on: boolean): string {
  return stageOnly(propSensorDay, on ? 'on' : 'off')
}
